...
public class DebugCommands {
	private PlanetWGEN plugin;


	public DebugCommands(PlanetWGEN plugin){
		this.plugin = plugin;
	}
	...
	public void pos(CommandContext args, CommandSource source) throws CommandException{
		...
		player.sendMessage(plugin.getPrefix(), ChatStyle.BLUE, "Pos: " + player.getTransform().getTransform().getPosition().toString());
		player.sendMessage(plugin.getPrefix(), ChatStyle.BLUE, "Chunk: " + player.getChunk().toString());
	}
}
